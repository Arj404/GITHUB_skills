...
2. **Ask using #tool:vscode/askQuestions**, structured as:
...
1. Ask about data characteristics (use #tool:vscode/askQuestions):
...
After writing all research artifacts, ask for approval using #tool:vscode/askQuestions:
